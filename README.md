...
Azure Container Apps offers great scaling capabilities, that when coupled with Orleans, enable you to scale effortlessly up and down on demand or release features using ACA's revision techniques without bringing your app offline. 
